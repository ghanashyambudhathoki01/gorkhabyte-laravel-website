                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between mt-6 pt-4 border-t border-gray-50 dark:border-gray-700">
                                <div class="flex items-center text-sm text-gray-500 dark:text-gray-400">
                                 ...
                                 @endif
                                 <a href="{{ route('training.show', $training->slug) }}" class="text-indigo-600 dark:text-indigo-400 font-semibold text-sm hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors flex items-center">
                                     View Details
