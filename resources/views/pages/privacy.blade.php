<x-public-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 space-y-8">
            ...
            <section>
                ...
                <p class="text-gray-700 leading-relaxed">
                    Welcome to Gorkhabyte Academy. We respect your privacy and are committed to protecting your personal data. 
            ...
            <section>
                ...
                <ul class="list-disc list-inside space-y-2 text-gray-700 ml-4">
                    <li>To register you as a new student or customer</li>
                    <li>To process and deliver your training courses and services</li>
                    <li>To manage our relationship with you, including notifying you about changes to our terms or privacy policy</li>
                    <li>To improve our website, products/services, marketing or customer relationships</li>
                    <li>To send you marketing communications about our training programs and services</li>
                </ul>
            </section>
            ...
            <section>
                ...
                <p class="text-gray-700 leading-relaxed">
                    ...
                    a good experience when you browse our website and also allows us to improve our site. A cookie is a small file 
                    of letters and numbers that we store on your browser or the hard drive of your computer if you agree. Cookies 
            ...
            <!-- Your Legal Rights -->
            <section>
                <h2 class="text-2xl font-semibold text-gray-900 mb-4">Your Legal Rights</h2>
                <p class="text-gray-700 leading-relaxed mb-4">
        ...
        <div class="text-center mt-8">
            <a href="{{ route('home') }}" class="inline-flex items-center text-indigo-600 hover:text-indigo-700 font-medium">
