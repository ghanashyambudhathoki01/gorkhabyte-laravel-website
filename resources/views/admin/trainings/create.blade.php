            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
                <form action="{{ route('admin.trainings.store') }}" method="POST" id="trainingForm" class="p-8 space-y-8" enctype="multipart/form-data">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Syllabus Field -->
                        <div class="space-y-2">
                            <label for="syllabus" class="block text-sm font-semibold text-gray-700">
                                Course Syllabus
                            </label>
...
- History of GorkhaByte
- Setting up the environment

Module 2: Advanced Techniques
- Integration with AI
- Scaling applications"
                                      class="block w-full px-4 py-3.5 text-gray-900 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 placeholder-gray-400 resize-none hover:border-gray-400">{{ old('syllabus') }}</textarea>
                            <p class="text-xs text-gray-500 flex items-center">
                                <svg class="w-3.5 h-3.5 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
                                </svg>
                                Use "Module X: Title" for module headers and "-" for list items.
                            </p>
                        </div>
                    </div>
