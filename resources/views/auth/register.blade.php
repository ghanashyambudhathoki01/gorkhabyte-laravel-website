            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div class="flex items-center">
                    ...
                    <label for="terms" class="ml-2 text-sm text-gray-600 dark:text-gray-400">
                        {{ __('I agree to the') }} 
                        <a href="{{ route('terms') }}" class="text-indigo-600 dark:text-indigo-400 hover:underline">{{ __('Terms of Service') }}</a> 
                        {{ __('and') }} 
                        <a href="{{ route('privacy') }}" class="text-indigo-600 dark:text-indigo-400 hover:underline">{{ __('Privacy Policy') }}</a>
                    </label>
                </div>
